-- ServerScriptService/Modules/RewardManager.lua (VERSI�N MEJORADA)
...
local PlayerManager = require(ServerScriptService.Modules.PlayerManager) -- Para saber qui�n est� vivo

local RewardManager = {}

-- Tabla de recompensas m�s detallada
local RECOMPENSAS = {
