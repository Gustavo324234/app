...
-- Esta variable nos dirá si una animación de acción forzada se está reproduciendo.
...
-- =============================================================================================
-- ==                  [[ SECCIÓN 1: AÑADIR TODA ESTA NUEVA FUNCIÓN AQUÍ ]]                   ==
-- =============================================================================================
-- Esta es nuestra nueva función para recibir órdenes del AnimationController.
local function playActionAnimation(animationId, data)
	...
	print("[SUBORDINADO - Animate] Animaciones base detenidas. Estado de acción: ACTIVADO.")
	...
	if not animator then
		warn("[SUBORDINADO - Animate] ¡FALLO! No se encontró Animator.")
		actionAnimPlaying = false
		return
	end
	print("[SUBORDINADO - Animate] Animator encontrado. Cargando animación...")

	local track = animator:LoadAnimation(animation)
	track.Priority = Enum.AnimationPriority.Action

	local looped = typeof(data) == "table" and data.Looped == true
	local duration = typeof(data) == "table" and tonumber(data.Duration) or nil
...
-- ... (El código desde aquí hasta la función "stepAnimate" es el tuyo original, sin cambios) ...
